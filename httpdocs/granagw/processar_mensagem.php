...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (!empty($_POST['mac']) && !empty($_POST['mensagem'])) {
        $mac = $_POST['mac'];
        ...
        try {
            ...
            $mensagemstatus = $result['mensagemstatus'];
                ...
                $mensagemstatus = $mensagemstatus == 1 ? 0 : 1;
			
			
            $stmt = $pdo->prepare("UPDATE telemetria SET mensagem = :mensagem , mensagemstatus = :mensagemstatus WHERE mac = :mac");
